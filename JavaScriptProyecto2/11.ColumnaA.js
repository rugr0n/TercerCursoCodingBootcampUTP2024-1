const maxFilas = 26; // Define el número máximo de filas para el patrón
const maxColumnas = 81; // Define el número máximo de columnas para ajustar el formato de salida en la consola

for (let fila = 0; fila < maxFilas; fila++) {  // Bucle para iterar sobre cada fila del patrón
  let output = '';  // Variable para construir la salida de cada fila
  for (let columna = 0; columna < fila; columna++) { // Bucle para agregar caracteres a la fila actual
...
Autores: Jerónimo Mape Soto - Juan Corredor
